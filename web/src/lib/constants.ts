...
export const CATEGORIES_CONFIG = [
    ...
    { label: "Exosome", keywords: ["엑소좀", "엑소코바이오", "브이타이드", "엑소좀주사", "ASCE"] },
    { label: "PDRN/PN", keywords: ["PN", "PDRN", "리쥬란", "파마리서치", "연어주사", "비타란", "리투오", "리바이브"] },
    { label: "Skinboosters", keywords: ["스킨부스터", "hADM", "인체조직", "힐로웨이브", "스킨바이브", "프로파일로", "동종진피"] },
    { label: "Machines (EBD)", keywords: ["HIFU", "RF", "고주파", "레이저", "울쎄라", "써마지", "슈링크", "인모드", "올리지오", "텐써마", "브이로", "더블로", "울트라포머", "리프테라", "포텐자", "시크릿", "실펌", "온다리프팅", "큐어젯", "노보젯", "엔파인더스"] },
    { label: "Corporate News", keywords: ["제테마", "휴젤", "종근당", "종근당바이오", "휴온스", "휴메딕스", "메디톡스", "바이오플러스", "원텍", "클래시스", "제이시스", "바임", "대웅제약", "갈더마", "멀츠", "앨러간", "시지바이오", "비엔씨", "엑소코", "에스테팜", "아크로스", "한스바이오베드", "비엠아이", "중헌제약", "MDR", "학회", "최소침습", "미용성형", "화장품", "제이월드", "네오닥터", "허가"] }
];
