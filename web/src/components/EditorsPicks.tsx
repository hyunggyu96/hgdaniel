...
function AdminModal({
    ...
    return (
        <>
            ...
            >
                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl w-screen h-screen max-w-none max-h-none flex flex-col overflow-hidden pointer-events-auto">
                    {/* Header */}
