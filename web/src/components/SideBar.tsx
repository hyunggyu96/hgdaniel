...
export default function SideBar() {
    ...
    return (
        <aside className="w-64 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 p-6 hidden lg:block">
            <div className="space-y-8">
                <div>
                    ...
                    <div className="space-y-1">
                        <Link
                            href="/"
                            prefetch={true}
                            className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 group flex items-center justify-between ${isOverview ? 'bg-[#3182f6] text-white' : 'text-muted-foreground hover:bg-gray-200 dark:hover:bg-gray-800 hover:text-foreground'}`}
                        >
                        ...
                        {CATEGORIES.map((category) => (
                            <Link
                                ...
                                prefetch={true}
                                className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 group flex items-center justify-between ${selectedCategory === category ? 'bg-[#3182f6] text-white' : 'text-muted-foreground hover:bg-gray-200 dark:hover:bg-gray-800 hover:text-foreground'}`}
                            >
                ...
                <div className="pt-6 border-t border-gray-200 dark:border-gray-800">
                    <Link
                        ...
                        prefetch={true}
                        className={`flex items-center justify-between gap-3 px-4 py-3 rounded-xl transition-all group/collections ${isCollections ? 'bg-[#3182f6] text-white' : 'hover:bg-gray-200 dark:hover:bg-gray-800'}`}
                    >
