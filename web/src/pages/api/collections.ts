...
const TARGET_SHEET_TITLE = 'UserCollections'; // Single unified sheet
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        if (!sheet) {
            sheet = await doc.addSheet({ title: TARGET_SHEET_TITLE, headerValues: ['UserID', 'Title', 'URL', 'Date', 'AddedAt'] });
        }
